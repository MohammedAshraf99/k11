...
export class FavProductComponent {
  ...
  readonly favorites = signal<PerfumeProduct[]>([
    {
      ...
      price: 145.00,
      imageUrl: 'https://images.unsplash.com/photo-1616949755610-8c9bbc08f138?auto=format&fit=crop&w=400&q=80',
      inStock: true
    },
    {
      id: 102,
      ...
      price: 89.99,
      imageUrl: 'https://images.unsplash.com/photo-1547887537-6158d64c35b3?auto=format&fit=crop&w=400&q=80',
      inStock: true
    },
    {
      id: 103,
  ...
  private lastRemovedItem: { item: PerfumeProduct; index: number } | null = null;
  ...
  handleAddToCart(product: PerfumeProduct): void {
    ...
    this.toastService.show(`Added ${product.name} to your shopping bag!`, 'success');
  }
}